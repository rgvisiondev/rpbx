export const experts = [
  {
    ...
    contactHeadline: "Navigating a merger, acquisition, or complex business agreement?"
  },
  {
    index: 2,
    name: "Abby Young",
    ...
    contactHeadline: "Need clarity on taxes, cash flow strategy, or financial planning?"
  },
  {
    index: 3,
    name: "Juan A. Garcia",
    ...
    contactHeadline: "Evaluating an acquisition, investment structure, or capital strategy?"
  },
  {
    index: 4,
    name: "Bill Martin",
