// app/components/valuate-cta.tsx
  ...
  return (
    <section className="max-w-[1140px] mx-auto px-3 lg:px-1 py-10">
      <div className="bg-[url('/images/backgrounds/footer-bg.png')] bg-fixed bg-center rounded-[40px] p-8 text-white grid lg:grid-cols-2 gap-2 lg:gap-12 items-center relative overflow-hidden">
        <div className="absolute -top-24 -right-24 w-64 h-64 bg-[#4da685]/20 rounded-full blur-3xl" />
        ...
        <div className="space-y-4">
          <div className="p-5 bg-white/10 border border-white/10 rounded-3xl hover:bg-white/15 transition group">
            <div className="flex justify-between items-start mb-4 gap-2">
              <div>
                <span className="text-xs font-bold text-[#60BC9B] uppercase tracking-widest">
                  Recommended
                </span>
              ...
              <div className="text-right">
                {isFree ? (
                  <>
                    <span className="text-2xl font-bold">More Visibility</span>
            ...
            <Link href="/subscribe/business_monthly?trial=30">
              <button className="w-full py-4 bg-[#60BC9B] hover:bg-[#4da685] text-white font-bold rounded-2xl hover:cursor-pointer transition">
          ...
          <div className="p-5 bg-white/5 border border-white/5 rounded-3xl hover:bg-white/10 transition group text-center lg:text-left">
            <div className="lg:flex-col items-center">
              <h4 className="font-bold text-white pb-3">
                {isFree ? "Free Business Valuation" : "One-time Valuation"}
              </h4>

              {isFree ? (
                <a
                  href={`${BIZEQUITY_VALUATION_LINK}${BIZEQUITY_VALUATION_LINK.includes("?") ? "&" : "?"}source=${encodeURIComponent(sourcePage)}`}
                  target="_blank"
