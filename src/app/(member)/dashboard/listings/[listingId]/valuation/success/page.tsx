...
const BIZEQUITY_URL =
  process.env.BIZEQUITY_URL ?? "https://rioplexbizx.bizequity.com/";
const CALENDLY_URL =
  ...
  return (
    <div className="flex flex-col bg-[url('/images/backgrounds/white-bg.png')] bg-repeat bg-center min-h-screen justify-center p-4 lg:py-10">
      <div className="bg-white mx-auto max-w-lg lg:min-w-[500px] p-6 my-5 rounded-xl border border-neutral-200 shadow text-center">
        ...
        {/* Success badge */}
        <div
          className="mx-auto mt-8 mb-3 flex h-14 w-14 items-center justify-center rounded-full"
          style={{
        ...
        >
          <svg viewBox="0 0 24 24" className="h-7 w-7" aria-hidden="true">
            <path
              fill="currentColor"
              d="M9.00049 16.2002L4.80049 12.0002L3.40039 13.4003L9.00049 19.0004L21.0005 7.00039L19.6004 5.60029L9.00049 16.2002Z"
            />
          </svg>
        </div>

        <h1 className="text-2xl font-semibold">
          Your valuation purchase is confirmed
        </h1>
        <p className="mt-2 text-neutral-600">
          You’re all set to begin your business valuation. Start your valuation
          with our BizEquity partner or schedule time with a RioPlex consultant
          to walk through the process together.
        </p>

        {/* Primary CTAs */}
        <div className="mx-auto mt-6 flex flex-col gap-3">
          {/* Start valuation (BizEquity) */}
          <Button
            href={BIZEQUITY_URL}
            target="_blank"
        ...
        <p className="mt-4 text-sm text-neutral-600">
          We’ve also emailed you these links so you can come back to your
          valuation at any time.
        </p>

        {/* Secondary links */}
        <div className="mt-4 flex items-center justify-center gap-4 text-sm">
          <Link
            href={`/business-listing/${listingId}`}
            className="underline underline-offset-4 text-neutral-600 hover:text-neutral-800"
          >
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        Need a hand? Call{" "}
        <a href="tel:9563225942">956-322-5942</a> or email{" "}
