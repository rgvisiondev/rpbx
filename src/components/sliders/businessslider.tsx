...
export default function BusinessSlider({ isValuationEnabled = true }: { isValuationEnabled?: boolean }) {
      ...
      <div className="flex flex-col items-start w-full lg:w-[560px] py-8 lg:py-10 px-6 lg:px-2">
        {isValuationEnabled ? (
          ...
          <>
            ...
            <p className="lg:pr-15 pt-1">
              Connect with qualified investors on RPBX. List your business and reach buyers who are ready to invest.
            </p>
          </>
        )}
      </div>
