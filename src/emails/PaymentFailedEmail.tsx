...
export function PaymentFailedEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        We couldn’t process your recent payment. Please update your billing information.
      </Preview>
          ...
          <Container className="mx-auto my-8 w-full max-w-[600px] rounded-xl border border-gray-200 bg-white p-6">
            ...
            <Section>
              ...
              <Text className="mt-2 text-sm text-gray-700 leading-relaxed">
                ...
                This can happen for a variety of reasons, such as an expired card or
                insufficient funds.
              </Text>

              <Text className="mt-4 text-sm text-gray-700 leading-relaxed">
                To avoid any interruption to your RioPlex Business Exchange membership,
              ...
              <Text className="text-xs text-gray-500 leading-relaxed">
                We’ll automatically retry the payment after your billing information is updated.
                If you need assistance, please contact our support team at info@rioplexbizx.com.
              </Text>
            </Section>
